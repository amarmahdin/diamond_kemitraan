                        ...
                        <div class="px-4 py-4">
                            ...
                            <li :class="{'text-[#2671D9] font-semibold': $route.path === '/Approvaldisetujui', 'text-[#7F7F80]': $route.path !== '/Approvaldisetujui'}" class="py-2">
                                <router-link to="/Approvaldisetujui" class="hover:text-[#2671D9] text-base font-semibold tracking-widest relative group px-6" active-class="text-[#2671D9]" exact>
                                    Disetujui
                                    <div class="absolute w-full h-1 my-2  scale-x-0 group-hover:scale-x-100" :class="{'bg-[#2671D9]  scale-x-100': $route.path === '/Approvaldisetujui'}"></div>
                                </router-link>
                            </li>
                            ...
                            <table class="table-auto w-full text-left ">
                                ...
                                <tbody>
                                    <tr v-for="(row, index) in paginatedRows" :key="row.id" class="bg-white border-b text-sm text-[#333333] h-[54px]">
                                        ...
                                        <td class="w-[130px] px-3">
                                            <span class="px-[5px] bg-[#FFF3E6] text-[#FF8000] border-[#FFD6AD] py-1 text-xs font-medium border-1 rounded-[100px]">{{ row.statusap }}</span>
                                        </td>
