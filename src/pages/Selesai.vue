<template>
  <div>
    <div class="h-topbar flex items-center gap-1 px-6">
      <h1 class="text-sm text-[#7F7F80] pt-3 ml-6 font-medium">Selesai</h1>
    </div>
    <div class="page-body">
                                ...
                                <div v-show="isFilterStatus" class="absolute w-[240px] ml-[247px] mt-[90px] border-[1px] rounded-lg bg-white z-10">
                                    <ul class="text-sm w-full">
                                        ...
                                        <li @click="updateFilterStatus('Ditolak')" class="border-b h-[40px] flex items-center group hover:bg-[#E9F1FB]">
                                            ...
                                            <span class="text-[#333333] ml-2 group-hover:font-semibold group-hover:text-[#2671D9]" :class="{'text-[#2671D9] font-semibold': filterStatus === 'Ditolak'}">Ditolak</span>
                                        </li>
                                    </ul>
                                </div>
